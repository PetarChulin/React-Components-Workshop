...
import { formatDateAndTime } from "../utils/dataUtils";
                ...
                <div className="detail-container">
                    ...
                    <div className="content">
                        ...
                        <div className="user-details">
                            ...
                            <p>Created on: <strong>{formatDateAndTime(user.createdAt)}</strong></p>
                            <p>Modified on: <strong>{formatDateAndTime(user.updatedAt)}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
